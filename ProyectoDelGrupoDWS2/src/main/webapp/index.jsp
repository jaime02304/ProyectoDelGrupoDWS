...
<body>
	<nav class="navegador">
		...
		<a href="${pageContext.request.contextPath}/paginaAdministradora.jsp"  class="linkAdmin">
			<button class="botonAdmin">ADMINISTRADOR</button>
		</a>

		<!-- Enlace dinámico al login -->
		<a href="${pageContext.request.contextPath}/login.jsp"><svg xmlns="http://www.w3.org/2000/svg"
				viewBox="0 0 24 24" class="registroUsuario" width="60" height="60">
        <path
